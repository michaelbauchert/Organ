...
var app = (function () {
    ...
    /* src\OrganStopButton.svelte generated by Svelte v3.18.2 */

    const file = "src\\OrganStopButton.svelte";
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["stopType", "name", "active"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<OrganStopButton> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$set = $$props => {
    		if ("stopType" in $$props) $$invalidate(6, stopType = $$props.stopType);
    		if ("name" in $$props) $$invalidate(1, name = $$props.name);
    		if ("active" in $$props) $$invalidate(0, active = $$props.active);
    	};

    	$$self.$capture_state = () => {
    		return { stopType, name, active, x, y, id, color };
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*stopType, name*/ 66) {
    			 $$invalidate(2, id = stopType + "-" + name);
    		}

    		if ($$self.$$.dirty & /*stopType*/ 64) {
    			 $$invalidate(3, color = stopType === "flute" ? "primary" : "secondary");
    		}
    	};

    	return [active, name, id, color, x, y, stopType, input_change_handler];
    }

    class OrganStopButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { stopType: 6, name: 1, active: 0 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "OrganStopButton",
    			options,
    			id: create_fragment.name
    		});
    		...
    		if (/*stopType*/ ctx[6] === undefined && !("stopType" in props)) {
    			console.warn("<OrganStopButton> was created without expected prop 'stopType'");
    		}

    		if (/*name*/ ctx[1] === undefined && !("name" in props)) {
    			console.warn("<OrganStopButton> was created without expected prop 'name'");
    		}

    		if (/*active*/ ctx[0] === undefined && !("active" in props)) {
    			console.warn("<OrganStopButton> was created without expected prop 'active'");
    		}
    	}

    	get stopType() {
    		throw new Error("<OrganStopButton>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set stopType(value) {
    		throw new Error("<OrganStopButton>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src\PercussionStops.svelte generated by Svelte v3.18.2 */

    const { console: console_1 } = globals;
    const file$1 = "src\\PercussionStops.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	function organstopbutton_active_binding(value) {
    		/*organstopbutton_active_binding*/ ctx[12].call(null, value, /*stop*/ ctx[16]);
    	}

    	let organstopbutton_props = {
    		stopType: "percussion",
    		name: /*stop*/ ctx[16].name
    	};

    	if (/*stop*/ ctx[16].active !== void 0) {
    		organstopbutton_props.active = /*stop*/ ctx[16].active;
    	}

    	const organstopbutton = new OrganStopButton({
    			props: organstopbutton_props,
    			$$inline: true
    		});

    	binding_callbacks.push(() => bind(organstopbutton, "active", organstopbutton_active_binding));

    	const block = {
    		c: function create() {
    			create_component(organstopbutton.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(organstopbutton, target, anchor);
    			current = true;
    		},
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const organstopbutton_changes = {};
    			if (dirty & /*percussionStops*/ 1) organstopbutton_changes.name = /*stop*/ ctx[16].name;

    			if (!updating_active && dirty & /*percussionStops*/ 1) {
    				updating_active = true;
    				organstopbutton_changes.active = /*stop*/ ctx[16].active;
    				add_flush_callback(() => updating_active = false);
    			}

    			organstopbutton.$set(organstopbutton_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(organstopbutton.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(organstopbutton.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(organstopbutton, detaching);
    		}
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			ion_card_title.textContent = "PERCUSSION";
    			t1 = space();
    			...
    			ion_label0.textContent = "Volume";
    			t4 = space();
    			ion_range0 = element("ion-range");
    			t5 = space();
    			...
    			ion_label2.textContent = "Note Repeat";
    			t10 = space();
    			ion_toggle = element("ion-toggle");
    			t11 = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(ion_card, t1);
    			append_dev(ion_card, ion_card_content);

    			for (let i = 0; i < each_blocks.length; i += 1) {
    				each_blocks[i].m(ion_card_content, null);
    			}

    			append_dev(ion_card, t2);
    			append_dev(ion_card, ion_item0);
    			append_dev(ion_item0, ion_label0);
    			append_dev(ion_item0, t4);
    			append_dev(ion_item0, ion_range0);
    			...
    			append_dev(ion_item2, t10);
    			append_dev(ion_item2, ion_toggle);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*percussionStops*/ 1) {
    				each_value = /*percussionStops*/ ctx[0];
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { percussion = new Tone$1.PolySynth(6,
    	Tone$1.Synth,
    	{
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<PercussionStops> was created with unknown prop '${key}'`);
    	});

    	function organstopbutton_active_binding(value, stop) {
    		stop.active = value;
    		$$invalidate(0, percussionStops);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("percussion" in $$props) $$invalidate(7, percussion = $$props.percussion);
    		if ("percussionStops" in $$props) $$invalidate(0, percussionStops = $$props.percussionStops);
    		if ("volumeSignal" in $$props) $$invalidate(4, volumeSignal = $$props.volumeSignal);
    		if ("percOutput" in $$props) $$invalidate(8, percOutput = $$props.percOutput);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*percussion, percussionStops*/ 129) {
    			 percussion.set({
    				"oscillator": {
    					"partials": [
    						0,
    ...
    class PercussionStops extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get percussion() {
    		throw new Error("<PercussionStops>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set percussion(value) {
    		throw new Error("<PercussionStops>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src\FluteStops.svelte generated by Svelte v3.18.2 */
    const file$2 = "src\\FluteStops.svelte";
    ...
    // (59:4) {#each fluteStops as stop}
    function create_each_block$1(ctx) {
    	let updating_active;
    	let current;

    	function organstopbutton_active_binding(value) {
    		/*organstopbutton_active_binding*/ ctx[5].call(null, value, /*stop*/ ctx[7]);
    	}

    	let organstopbutton_props = {
    		stopType: "flute",
    		name: /*stop*/ ctx[7].name
    	};

    	if (/*stop*/ ctx[7].active !== void 0) {
    		organstopbutton_props.active = /*stop*/ ctx[7].active;
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const organstopbutton_changes = {};
    			if (dirty & /*fluteStops*/ 1) organstopbutton_changes.name = /*stop*/ ctx[7].name;

    			if (!updating_active && dirty & /*fluteStops*/ 1) {
    				updating_active = true;
    				organstopbutton_changes.active = /*stop*/ ctx[7].active;
    				add_flush_callback(() => updating_active = false);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:4) {#each fluteStops as stop}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let current;
    	let dispose;
    	let each_value = /*fluteStops*/ ctx[0];
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			ion_card_header = element("ion-card-header");
    			ion_card_title = element("ion-card-title");
    			ion_card_title.textContent = "FLUTES";
    			t1 = space();
    			ion_card_content = element("ion-card-content");
    			...
    			ion_label.textContent = "Volume";
    			t4 = space();
    			ion_range = element("ion-range");
    			add_location(ion_card_title, file$2, 55, 4, 1589);
    			add_location(ion_card_header, file$2, 54, 2, 1566);
    			set_custom_element_data(ion_card_content, "class", "svelte-h2sqff");
    			add_location(ion_card_content, file$2, 57, 2, 1655);
    			set_custom_element_data(ion_label, "position", "stacked");
    			add_location(ion_label, file$2, 64, 4, 1865);
    			set_custom_element_data(ion_range, "pin", "");
    			set_custom_element_data(ion_range, "mode", "ios");
    			set_custom_element_data(ion_range, "value", ion_range_value_value = Math.floor(/*volumeSignal*/ ctx[1].value * 1000));
    			add_location(ion_range, file$2, 65, 4, 1919);
    			set_custom_element_data(ion_item, "lines", "none");
    			add_location(ion_item, file$2, 63, 2, 1836);
    			set_custom_element_data(ion_card, "class", "svelte-h2sqff");
    			add_location(ion_card, file$2, 53, 0, 1552);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(ion_card, t2);
    			append_dev(ion_card, ion_item);
    			append_dev(ion_item, ion_label);
    			append_dev(ion_item, t4);
    			append_dev(ion_item, ion_range);
    			current = true;
    			dispose = listen_dev(ion_range, "ionChange", /*ionChange_handler*/ ctx[6], false, false, false);
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*fluteStops*/ 1) {
    				each_value = /*fluteStops*/ ctx[0];
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { flutes = new Tone$1.PolySynth(6,
    	Tone$1.Synth,
    	{
    			oscillator: { type: "sine" },
    			envelope: {
    	...
    	let volumeSignal = new Tone$1.Signal(0).chain(flutes.volume);
    	...
    	const writable_props = ["flutes"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<FluteStops> was created with unknown prop '${key}'`);
    	});

    	function organstopbutton_active_binding(value, stop) {
    		stop.active = value;
    		$$invalidate(0, fluteStops);
    	}

    	const ionChange_handler = e => volumeSignal.rampTo(e.target.value / 1000, 0.1);

    	$$self.$set = $$props => {
    		if ("flutes" in $$props) $$invalidate(2, flutes = $$props.flutes);
    	};

    	$$self.$capture_state = () => {
    		return { flutes, fluteStops, volumeSignal };
    	};

    	$$self.$inject_state = $$props => {
    		if ("flutes" in $$props) $$invalidate(2, flutes = $$props.flutes);
    		if ("fluteStops" in $$props) $$invalidate(0, fluteStops = $$props.fluteStops);
    		if ("volumeSignal" in $$props) $$invalidate(1, volumeSignal = $$props.volumeSignal);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*flutes, fluteStops*/ 5) {
    			 flutes.set({
    				"oscillator": {
    					"partials": [
    						fluteStops[0].active ? 1 : 0,
    ...
    class FluteStops extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { flutes: 2, playNote: 3, stopNote: 4 });
    	...
    	get flutes() {
    		throw new Error("<FluteStops>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set flutes(value) {
    		throw new Error("<FluteStops>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src\SpecialEffects.svelte generated by Svelte v3.18.2 */
    const file$3 = "src\\SpecialEffects.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	let t19;
    	let ion_select_option2;
    	let t21;
    	let ion_select_option3;
    	let t23;
    	let ion_select_option4;
    	let t25;
    	let ion_item5;
    	let ion_label5;
    	let t27;
    	let ion_range3;
    	let ion_range3_value_value;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			ion_card_header = element("ion-card-header");
    			ion_card_title = element("ion-card-title");
    			ion_card_title.textContent = "SPECIAL EFFECTS";
    			t1 = space();
    			ion_item0 = element("ion-item");
    			ion_label0 = element("ion-label");
    			ion_label0.textContent = "Piano";
    			t3 = space();
    			ion_range0 = element("ion-range");
    			t4 = space();
    			ion_item1 = element("ion-item");
    			ion_label1 = element("ion-label");
    			ion_label1.textContent = "Harpsichord";
    			t6 = space();
    			ion_range1 = element("ion-range");
    			t7 = space();
    			ion_item2 = element("ion-item");
    			ion_label2 = element("ion-label");
    			ion_label2.textContent = "Vibrato";
    			t9 = space();
    			ion_toggle = element("ion-toggle");
    			t10 = space();
    			ion_item3 = element("ion-item");
    			...
    			ion_range2 = element("ion-range");
    			t13 = space();
    			ion_item4 = element("ion-item");
    			ion_label4 = element("ion-label");
    			ion_label4.textContent = "Reverb";
    			t15 = space();
    			ion_select = element("ion-select");
    			ion_select_option0 = element("ion-select-option");
    			ion_select_option0.textContent = "Off";
    			t17 = space();
    			ion_select_option1 = element("ion-select-option");
    			ion_select_option1.textContent = "The Barn";
    			t19 = space();
    			ion_select_option2 = element("ion-select-option");
    			ion_select_option2.textContent = "Cathedral (Large)";
    			t21 = space();
    			ion_select_option3 = element("ion-select-option");
    			ion_select_option3.textContent = "Cathedral (Small)";
    			t23 = space();
    			ion_select_option4 = element("ion-select-option");
    			ion_select_option4.textContent = "Spring";
    			t25 = space();
    			ion_item5 = element("ion-item");
    			ion_label5 = element("ion-label");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(ion_card, ion_item0);
    			append_dev(ion_item0, ion_label0);
    			append_dev(ion_item0, t3);
    			append_dev(ion_item0, ion_range0);
    			append_dev(ion_card, t4);
    			append_dev(ion_card, ion_item1);
    			append_dev(ion_item1, ion_label1);
    			append_dev(ion_item1, t6);
    			append_dev(ion_item1, ion_range1);
    			append_dev(ion_card, t7);
    			append_dev(ion_card, ion_item2);
    			append_dev(ion_item2, ion_label2);
    			append_dev(ion_item2, t9);
    			append_dev(ion_item2, ion_toggle);
    			append_dev(ion_card, t10);
    			append_dev(ion_card, ion_item3);
    			append_dev(ion_item3, ion_label3);
    			append_dev(ion_item3, t12);
    			append_dev(ion_item3, ion_range2);
    			append_dev(ion_card, t13);
    			append_dev(ion_card, ion_item4);
    			append_dev(ion_item4, ion_label4);
    			append_dev(ion_item4, t15);
    			append_dev(ion_item4, ion_select);
    			append_dev(ion_select, ion_select_option0);
    			append_dev(ion_select, t17);
    			append_dev(ion_select, ion_select_option1);
    			append_dev(ion_select, t19);
    			append_dev(ion_select, ion_select_option2);
    			append_dev(ion_select, t21);
    			append_dev(ion_select, ion_select_option3);
    			append_dev(ion_select, t23);
    			append_dev(ion_select, ion_select_option4);
    			append_dev(ion_card, t25);
    			append_dev(ion_card, ion_item5);
    			append_dev(ion_item5, ion_label5);
    			append_dev(ion_item5, t27);
    			append_dev(ion_item5, ion_range3);

    			dispose = [
    				listen_dev(ion_range0, "ionChange", /*ionChange_handler*/ ctx[18], false, false, false),
    				listen_dev(ion_range1, "ionChange", /*ionChange_handler_1*/ ctx[19], false, false, false),
    				listen_dev(ion_toggle, "ionChange", /*ionChange_handler_2*/ ctx[20], false, false, false),
    				listen_dev(ion_range2, "ionChange", /*ionChange_handler_3*/ ctx[21], false, false, false),
    				listen_dev(ion_select, "ionChange", /*ionChange_handler_4*/ ctx[22], false, false, false),
    				listen_dev(ion_range3, "ionChange", /*ionChange_handler_5*/ ctx[23], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*vibratoState*/ 2) {
    				set_custom_element_data(ion_toggle, "checked", /*vibratoState*/ ctx[1]);
    			}

    			if (dirty & /*vibratoState*/ 2 && ion_range2_disabled_value !== (ion_range2_disabled_value = !/*vibratoState*/ ctx[1])) {
    				set_custom_element_data(ion_range2, "disabled", ion_range2_disabled_value);
    			}
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { detune = new Tone$1.Signal(0, Tone$1.Type.Cents) } = $$props;
    	let normalizeUpper = new Tone$1.Normalize(0, 2400);
    	let scaleUpper = new Tone$1.Scale(0, 1);
    	normalizeUpper.connect(scaleUpper);
    	let normalizeLower = new Tone$1.Normalize(-2400, 0);
    	let scaleLower = new Tone$1.Scale(0.5, 1);
    	normalizeLower.connect(scaleLower);
    	let add = new Tone$1.Add();
    	...
    	Tone$1.Sampler.prototype.triggerAttack = function (notes, time, velocity) {
    		...
    		for (var i = 0; i < notes.length; i++) {
    			var midi = Tone$1.Frequency(notes[i]).toMidi();
    			...
    			var playbackRate = Tone$1.intervalToFrequencyRatio(difference);

    			// play that note
    			var source = new Tone$1.BufferSource({
    					buffer,
    					playbackRate,
    					"fadeIn": this.attack,
    			...
    			var detune = new Tone$1.Multiply(playbackRate).connect(source.playbackRate);
    			add.connect(detune);
    			source.start(time, 0, buffer.duration / playbackRate, velocity);

    			// add it to the active sources
    			if (!Tone$1.isArray(this._activeSources[midi])) {
    	...
    	let { harpsichord = new Tone$1.Sampler({
    	...
    	let pianoVolume = new Tone$1.Signal(0).chain(piano.volume);
    	let harpsichordVolume = new Tone$1.Signal(0).chain(harpsichord.volume);
    	...
    	const vibrato = new Tone$1.Vibrato(5, 0.15);
    	let vibratoState;
    ...
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SpecialEffects> was created with unknown prop '${key}'`);
    	});

    	const ionChange_handler = e => pianoVolume.rampTo(e.target.value / 100, 0.1);
    ...
    /* src\SyntheSlalom.svelte generated by Svelte v3.18.2 */
    const file$4 = "src\\SyntheSlalom.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			ion_card_header = element("ion-card-header");
    			ion_card_title = element("ion-card-title");
    			ion_card_title.textContent = "SYNTHESLALOM";
    			t1 = space();
    			ion_item0 = element("ion-item");
    			ion_label0 = element("ion-label");
    			ion_label0.textContent = "Range";
    			t3 = space();
    			ion_range0 = element("ion-range");
    			t4 = space();
    			ion_item1 = element("ion-item");
    			ion_label1 = element("ion-label");
    			ion_label1.textContent = "Timer";
    			t6 = space();
    			ion_range1 = element("ion-range");
    			t7 = space();
    			ion_item2 = element("ion-item");
    			ion_label2 = element("ion-label");
    			ion_label2.textContent = "Direction";
    			t9 = space();
    			ion_select = element("ion-select");
    			ion_select_option0 = element("ion-select-option");
    			ion_select_option0.textContent = "Up";
    			t11 = space();
    			ion_select_option1 = element("ion-select-option");
    			ion_select_option1.textContent = "Down";
    			add_location(ion_card_title, file$4, 20, 4, 453);
    			add_location(ion_card_header, file$4, 19, 2, 430);
    			set_custom_element_data(ion_label0, "position", "stacked");
    			add_location(ion_label0, file$4, 24, 4, 555);
    			set_custom_element_data(ion_range0, "min", "0");
    			set_custom_element_data(ion_range0, "max", "24");
    			set_custom_element_data(ion_range0, "mode", "ios");
    			set_custom_element_data(ion_range0, "snaps", "");
    			set_custom_element_data(ion_range0, "value", ion_range0_value_value = /*range*/ ctx[0] / 100);
    			add_location(ion_range0, file$4, 25, 4, 608);
    			set_custom_element_data(ion_item0, "lines", "none");
    			add_location(ion_item0, file$4, 23, 2, 526);
    			set_custom_element_data(ion_label1, "position", "stacked");
    			add_location(ion_label1, file$4, 33, 4, 798);
    			set_custom_element_data(ion_range1, "min", "0");
    			set_custom_element_data(ion_range1, "max", "5000");
    			set_custom_element_data(ion_range1, "pin", "");
    			set_custom_element_data(ion_range1, "mode", "ios");
    			set_custom_element_data(ion_range1, "value", ion_range1_value_value = Math.floor(/*timer*/ ctx[1] * 1000));
    			add_location(ion_range1, file$4, 34, 4, 851);
    			add_location(ion_item1, file$4, 32, 2, 782);
    			add_location(ion_label2, file$4, 41, 4, 1061);
    			set_custom_element_data(ion_select_option0, "value", "up");
    			add_location(ion_select_option0, file$4, 45, 6, 1263);
    			set_custom_element_data(ion_select_option1, "value", "down");
    			add_location(ion_select_option1, file$4, 46, 6, 1323);
    			set_custom_element_data(ion_select, "interface", "popover");
    			set_custom_element_data(ion_select, "value", ion_select_value_value = /*direction*/ ctx[2] === -1 ? "up" : "down");
    			add_location(ion_select, file$4, 42, 4, 1099);
    			set_custom_element_data(ion_item2, "lines", "none");
    			add_location(ion_item2, file$4, 40, 2, 1032);
    			set_custom_element_data(ion_card, "class", "svelte-4y60wk");
    			add_location(ion_card, file$4, 18, 0, 416);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(ion_item2, ion_label2);
    			append_dev(ion_item2, t9);
    			append_dev(ion_item2, ion_select);
    			append_dev(ion_select, ion_select_option0);
    			append_dev(ion_select, t11);
    			append_dev(ion_select, ion_select_option1);

    			dispose = [
    				listen_dev(ion_range0, "ionChange", /*ionChange_handler*/ ctx[6], false, false, false),
    				listen_dev(ion_range1, "ionChange", /*ionChange_handler_1*/ ctx[7], false, false, false),
    				listen_dev(ion_select, "ionChange", /*ionChange_handler_2*/ ctx[8], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*range*/ 1 && ion_range0_value_value !== (ion_range0_value_value = /*range*/ ctx[0] / 100)) {
    				set_custom_element_data(ion_range0, "value", ion_range0_value_value);
    			}

    			if (dirty & /*timer*/ 2 && ion_range1_value_value !== (ion_range1_value_value = Math.floor(/*timer*/ ctx[1] * 1000))) {
    				set_custom_element_data(ion_range1, "value", ion_range1_value_value);
    			}

    			if (dirty & /*direction*/ 4 && ion_select_value_value !== (ion_select_value_value = /*direction*/ ctx[2] === -1 ? "up" : "down")) {
    				set_custom_element_data(ion_select, "value", ion_select_value_value);
    			}
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let { slalomSignal = new Tone$1.Signal(0) } = $$props;
    	let range = 0;
    	let timer = 0;
    	...
    	function startSlalom() {
    		if (range !== 0 && timer !== 0) {
    			$$invalidate(3, slalomSignal.value = adjustedRange, slalomSignal);
    			slalomSignal.targetRampTo(0, timer);
    		}
    	}

    	const writable_props = ["slalomSignal"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SyntheSlalom> was created with unknown prop '${key}'`);
    	});

    	const ionChange_handler = e => $$invalidate(0, range = e.target.value * 100);
    	const ionChange_handler_1 = e => $$invalidate(1, timer = e.target.value / 1000);
    	const ionChange_handler_2 = e => $$invalidate(2, direction = e.target.value === "up" ? -1 : 1);

    	$$self.$set = $$props => {
    		if ("slalomSignal" in $$props) $$invalidate(3, slalomSignal = $$props.slalomSignal);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("adjustedRange" in $$props) adjustedRange = $$props.adjustedRange;
    	};

    	let adjustedRange;

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*range, direction*/ 5) {
    ...
    class SyntheSlalom extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { slalomSignal: 3, startSlalom: 4 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "SyntheSlalom",
    			options,
    			id: create_fragment$4.name
    		});
    	}
    	...
    	get slalomSignal() {
    		throw new Error("<SyntheSlalom>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set slalomSignal(value) {
    		throw new Error("<SyntheSlalom>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    	...
    	set startSlalom(value) {
    		throw new Error("<SyntheSlalom>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src\BassSplit.svelte generated by Svelte v3.18.2 */
    const file$5 = "src\\BassSplit.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	let t13;
    	let ion_toggle1;
    	let ion_toggle1_disabled_value;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			ion_item0 = element("ion-item");
    			ion_card_title = element("ion-card-title");
    			ion_card_title.textContent = "BASS SPLIT";
    			t1 = space();
    			ion_toggle0 = element("ion-toggle");
    			t2 = space();
    			ion_item1 = element("ion-item");
    			ion_label0 = element("ion-label");
    			ion_label0.textContent = "Bass";
    			t4 = space();
    			ion_range0 = element("ion-range");
    			t5 = space();
    			ion_item2 = element("ion-item");
    			ion_label1 = element("ion-label");
    			ion_label1.textContent = "Strings";
    			t7 = space();
    			ion_range1 = element("ion-range");
    			t8 = space();
    			ion_item3 = element("ion-item");
    			ion_label2 = element("ion-label");
    			ion_label2.textContent = "Attack";
    			t10 = space();
    			ion_range2 = element("ion-range");
    			t11 = space();
    			ion_item4 = element("ion-item");
    			ion_label3 = element("ion-label");
    			ion_label3.textContent = "Monophonic";
    			t13 = space();
    			ion_toggle1 = element("ion-toggle");
    			add_location(ion_card_title, file$5, 73, 4, 1570);
    			set_custom_element_data(ion_toggle0, "slot", "end");
    			set_custom_element_data(ion_toggle0, "mode", "md");
    			add_location(ion_toggle0, file$5, 74, 4, 1620);
    			set_custom_element_data(ion_item0, "lines", "none");
    			add_location(ion_item0, file$5, 72, 2, 1540);
    			set_custom_element_data(ion_label0, "position", "stacked");
    			add_location(ion_label0, file$5, 78, 4, 1770);
    			set_custom_element_data(ion_range0, "mode", "ios");
    			set_custom_element_data(ion_range0, "disabled", ion_range0_disabled_value = !/*bassSplitState*/ ctx[0]);
    			set_custom_element_data(ion_range0, "value", ion_range0_value_value = Math.floor(/*volumeBass*/ ctx[2].value * 1000));
    			add_location(ion_range0, file$5, 79, 4, 1822);
    			set_custom_element_data(ion_item1, "lines", "none");
    			add_location(ion_item1, file$5, 77, 2, 1741);
    			set_custom_element_data(ion_label1, "position", "stacked");
    			add_location(ion_label1, file$5, 86, 4, 2049);
    			set_custom_element_data(ion_range1, "mode", "ios");
    			set_custom_element_data(ion_range1, "disabled", ion_range1_disabled_value = !/*bassSplitState*/ ctx[0]);
    			set_custom_element_data(ion_range1, "value", ion_range1_value_value = Math.floor(/*volumeStrings*/ ctx[3].value * 1000));
    			add_location(ion_range1, file$5, 87, 4, 2104);
    			add_location(ion_item2, file$5, 85, 2, 2033);
    			set_custom_element_data(ion_label2, "position", "stacked");
    			add_location(ion_label2, file$5, 94, 4, 2337);
    			set_custom_element_data(ion_range2, "mode", "ios");
    			set_custom_element_data(ion_range2, "disabled", ion_range2_disabled_value = !/*bassSplitState*/ ctx[0]);
    			set_custom_element_data(ion_range2, "min", "10");
    			set_custom_element_data(ion_range2, "max", "1000");
    			add_location(ion_range2, file$5, 95, 4, 2391);
    			add_location(ion_item3, file$5, 93, 2, 2321);
    			add_location(ion_label3, file$5, 104, 4, 2573);
    			set_custom_element_data(ion_toggle1, "slot", "end");
    			set_custom_element_data(ion_toggle1, "mode", "md");
    			set_custom_element_data(ion_toggle1, "disabled", ion_toggle1_disabled_value = !/*bassSplitState*/ ctx[0]);
    			add_location(ion_toggle1, file$5, 105, 4, 2612);
    			set_custom_element_data(ion_item4, "lines", "none");
    			add_location(ion_item4, file$5, 103, 2, 2544);
    			set_custom_element_data(ion_card, "class", "svelte-7enaj9");
    			add_location(ion_card, file$5, 70, 0, 1524);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ion_card, anchor);
    			append_dev(ion_card, ion_item0);
    			append_dev(ion_item0, ion_card_title);
    			append_dev(ion_item0, t1);
    			append_dev(ion_item0, ion_toggle0);
    			append_dev(ion_card, t2);
    			append_dev(ion_card, ion_item1);
    			append_dev(ion_item1, ion_label0);
    			append_dev(ion_item1, t4);
    			append_dev(ion_item1, ion_range0);
    			append_dev(ion_card, t5);
    			append_dev(ion_card, ion_item2);
    			append_dev(ion_item2, ion_label1);
    			append_dev(ion_item2, t7);
    			append_dev(ion_item2, ion_range1);
    			append_dev(ion_card, t8);
    			append_dev(ion_card, ion_item3);
    			append_dev(ion_item3, ion_label2);
    			append_dev(ion_item3, t10);
    			append_dev(ion_item3, ion_range2);
    			append_dev(ion_card, t11);
    			append_dev(ion_card, ion_item4);
    			append_dev(ion_item4, ion_label3);
    			append_dev(ion_item4, t13);
    			append_dev(ion_item4, ion_toggle1);

    			dispose = [
    				listen_dev(ion_toggle0, "ionChange", /*ionChange_handler*/ ctx[10], false, false, false),
    				listen_dev(ion_range0, "ionChange", /*ionChange_handler_1*/ ctx[11], false, false, false),
    				listen_dev(ion_range1, "ionChange", /*ionChange_handler_2*/ ctx[12], false, false, false),
    				listen_dev(ion_range2, "ionChange", /*setAttack*/ ctx[4], false, false, false),
    				listen_dev(ion_toggle1, "ionChange", /*monoToggle*/ ctx[1], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*bassSplitState*/ 1 && ion_range0_disabled_value !== (ion_range0_disabled_value = !/*bassSplitState*/ ctx[0])) {
    				set_custom_element_data(ion_range0, "disabled", ion_range0_disabled_value);
    			}

    			if (dirty & /*bassSplitState*/ 1 && ion_range1_disabled_value !== (ion_range1_disabled_value = !/*bassSplitState*/ ctx[0])) {
    				set_custom_element_data(ion_range1, "disabled", ion_range1_disabled_value);
    			}

    			if (dirty & /*bassSplitState*/ 1 && ion_range2_disabled_value !== (ion_range2_disabled_value = !/*bassSplitState*/ ctx[0])) {
    				set_custom_element_data(ion_range2, "disabled", ion_range2_disabled_value);
    			}

    			if (dirty & /*bassSplitState*/ 1 && ion_toggle1_disabled_value !== (ion_toggle1_disabled_value = !/*bassSplitState*/ ctx[0])) {
    				set_custom_element_data(ion_toggle1, "disabled", ion_toggle1_disabled_value);
    			}
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	let { bassSplitState = false } = $$props;

    	let { bass = new Tone$1.PolySynth(4,
    	Tone$1.Synth,
    	{
    			oscillator: { type: "sine" },
    			envelope: {
    	...
    	let { strings = new Tone$1.PolySynth(4,
    	Tone$1.Synth,
    	{
    	...
    	let volumeBass = new Tone$1.Signal(0).chain(bass.volume);
    	let volumeStrings = new Tone$1.Signal(0).chain(strings.volume);

    	function setAttack(event) {
    		bass.set({
    			"envelope": { "decay": event.target.value / 1000 }
    		});
    	...
    	const writable_props = ["bassSplitState", "bass", "strings"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<BassSplit> was created with unknown prop '${key}'`);
    	});

    	const ionChange_handler = e => $$invalidate(0, bassSplitState = e.target.checked);
    	const ionChange_handler_1 = e => volumeBass.rampTo(e.target.value / 1000, 0.1);
    	const ionChange_handler_2 = e => volumeStrings.rampTo(e.target.value / 1000, 0.1);

    	$$self.$set = $$props => {
    		if ("bassSplitState" in $$props) $$invalidate(0, bassSplitState = $$props.bassSplitState);
    		if ("bass" in $$props) $$invalidate(5, bass = $$props.bass);
    		if ("strings" in $$props) $$invalidate(6, strings = $$props.strings);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("bass" in $$props) $$invalidate(5, bass = $$props.bass);
    		if ("strings" in $$props) $$invalidate(6, strings = $$props.strings);
    		if ("mono" in $$props) mono = $$props.mono;
    		if ("volumeBass" in $$props) $$invalidate(2, volumeBass = $$props.volumeBass);
    		if ("volumeStrings" in $$props) $$invalidate(3, volumeStrings = $$props.volumeStrings);
    	};
    ...
    class BassSplit extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get bassSplitState() {
    		throw new Error("<BassSplit>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set bassSplitState(value) {
    		throw new Error("<BassSplit>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_fragment$6(ctx) {
    	...
    	let updating_flutes;
    	let t1;
    	let updating_percussion;
    	let updating_percOutput;
    	let t2;
    	let updating_bassSplitState;
    	let updating_bass;
    	let updating_strings;
    	let t3;
    	let updating_detune;
    	let updating_piano;
    	let updating_harpsichord;
    	let updating_vibrato;
    	let t4;
    	let updating_slalomSignal;
    	let t5;
    	let button;
    	let t7;
    	let script0;
    	...
    	function flutestops_flutes_binding(value) {
    		/*flutestops_flutes_binding*/ ctx[15].call(null, value);
    	}

    	let flutestops_props = {};

    	if (/*synths*/ ctx[7][2] !== void 0) {
    		flutestops_props.flutes = /*synths*/ ctx[7][2];
    	}

    	const flutestops = new FluteStops({ props: flutestops_props, $$inline: true });
    	/*flutestops_binding*/ ctx[14](flutestops);
    	binding_callbacks.push(() => bind(flutestops, "flutes", flutestops_flutes_binding));

    	function percussionstops_percussion_binding(value_1) {
    		/*percussionstops_percussion_binding*/ ctx[17].call(null, value_1);
    	}

    	function percussionstops_percOutput_binding(value_2) {
    		/*percussionstops_percOutput_binding*/ ctx[18].call(null, value_2);
    	}

    	let percussionstops_props = {};

    	if (/*synths*/ ctx[7]["percussion"] !== void 0) {
    		percussionstops_props.percussion = /*synths*/ ctx[7]["percussion"];
    	}

    	if (/*percOutput*/ ctx[10] !== void 0) {
    		percussionstops_props.percOutput = /*percOutput*/ ctx[10];
    	}

    	const percussionstops = new PercussionStops({
    			props: percussionstops_props,
    			$$inline: true
    		});

    	/*percussionstops_binding*/ ctx[16](percussionstops);
    	binding_callbacks.push(() => bind(percussionstops, "percussion", percussionstops_percussion_binding));
    	binding_callbacks.push(() => bind(percussionstops, "percOutput", percussionstops_percOutput_binding));

    	function basssplit_bassSplitState_binding(value_3) {
    		/*basssplit_bassSplitState_binding*/ ctx[20].call(null, value_3);
    	}

    	function basssplit_bass_binding(value_4) {
    		/*basssplit_bass_binding*/ ctx[21].call(null, value_4);
    	}

    	function basssplit_strings_binding(value_5) {
    		/*basssplit_strings_binding*/ ctx[22].call(null, value_5);
    	}

    	let basssplit_props = {};

    	if (/*bassSplit*/ ctx[5] !== void 0) {
    		basssplit_props.bassSplitState = /*bassSplit*/ ctx[5];
    	}

    	if (/*synths*/ ctx[7]["bass"] !== void 0) {
    		basssplit_props.bass = /*synths*/ ctx[7]["bass"];
    	}

    	if (/*synths*/ ctx[7]["bassStrings"] !== void 0) {
    		basssplit_props.strings = /*synths*/ ctx[7]["bassStrings"];
    	}

    	const basssplit = new BassSplit({ props: basssplit_props, $$inline: true });
    	/*basssplit_binding*/ ctx[19](basssplit);
    	binding_callbacks.push(() => bind(basssplit, "bassSplitState", basssplit_bassSplitState_binding));
    	binding_callbacks.push(() => bind(basssplit, "bass", basssplit_bass_binding));
    	binding_callbacks.push(() => bind(basssplit, "strings", basssplit_strings_binding));

    	function specialeffects_detune_binding(value_6) {
    		/*specialeffects_detune_binding*/ ctx[24].call(null, value_6);
    	}

    	function specialeffects_piano_binding(value_7) {
    		/*specialeffects_piano_binding*/ ctx[25].call(null, value_7);
    	}

    	function specialeffects_harpsichord_binding(value_8) {
    		/*specialeffects_harpsichord_binding*/ ctx[26].call(null, value_8);
    	}

    	function specialeffects_vibrato_binding(value_9) {
    		/*specialeffects_vibrato_binding*/ ctx[27].call(null, value_9);
    	}

    	let specialeffects_props = {};

    	if (/*fxDetune*/ ctx[6] !== void 0) {
    		specialeffects_props.detune = /*fxDetune*/ ctx[6];
    	}

    	if (/*synths*/ ctx[7]["fxPiano"] !== void 0) {
    		specialeffects_props.piano = /*synths*/ ctx[7]["fxPiano"];
    	}

    	if (/*synths*/ ctx[7]["fxHarpsichord"] !== void 0) {
    		specialeffects_props.harpsichord = /*synths*/ ctx[7]["fxHarpsichord"];
    	}

    	if (/*fxInput*/ ctx[9] !== void 0) {
    		specialeffects_props.vibrato = /*fxInput*/ ctx[9];
    	}

    	const specialeffects = new SpecialEffects({
    			props: specialeffects_props,
    			$$inline: true
    		});

    	/*specialeffects_binding*/ ctx[23](specialeffects);
    	binding_callbacks.push(() => bind(specialeffects, "detune", specialeffects_detune_binding));
    	binding_callbacks.push(() => bind(specialeffects, "piano", specialeffects_piano_binding));
    	binding_callbacks.push(() => bind(specialeffects, "harpsichord", specialeffects_harpsichord_binding));
    	binding_callbacks.push(() => bind(specialeffects, "vibrato", specialeffects_vibrato_binding));

    	function syntheslalom_slalomSignal_binding(value_10) {
    		/*syntheslalom_slalomSignal_binding*/ ctx[29].call(null, value_10);
    	}

    	let syntheslalom_props = {};

    	if (/*slalomSignal*/ ctx[8] !== void 0) {
    		syntheslalom_props.slalomSignal = /*slalomSignal*/ ctx[8];
    	}

    	const syntheslalom = new SyntheSlalom({
    			props: syntheslalom_props,
    			$$inline: true
    		});

    	/*syntheslalom_binding*/ ctx[28](syntheslalom);
    	binding_callbacks.push(() => bind(syntheslalom, "slalomSignal", syntheslalom_slalomSignal_binding));

    	const block = {
    		c: function create() {
    			ion_app = element("ion-app");
    			midi_input = element("midi-input");
    			t0 = space();
    			ion_content = element("ion-content");
    			div = element("div");
    			create_component(flutestops.$$.fragment);
    			t1 = space();
    			create_component(percussionstops.$$.fragment);
    			t2 = space();
    			create_component(basssplit.$$.fragment);
    			t3 = space();
    			create_component(specialeffects.$$.fragment);
    			t4 = space();
    			create_component(syntheslalom.$$.fragment);
    			t5 = space();
    			...
    			add_location(midi_input, file$6, 82, 2, 2003);
    			attr_dev(div, "class", "svelte-1mmzpr3");
    			add_location(div, file$6, 84, 4, 2203);
    			set_custom_element_data(ion_content, "class", "ion-justify-content-center ion-wrap");
    			set_custom_element_data(ion_content, "color", "dark");
    			add_location(ion_content, file$6, 83, 2, 2128);
    			add_location(ion_app, file$6, 81, 0, 1991);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "name", "button");
    			add_location(button, file$6, 115, 0, 2914);
    			attr_dev(script0, "type", "module");
    			if (script0.src !== (script0_src_value = "midi-input.js")) attr_dev(script0, "src", script0_src_value);
    			add_location(script0, file$6, 136, 2, 3429);
    			attr_dev(script1, "type", "module");
    			if (script1.src !== (script1_src_value = "https://cdn.jsdelivr.net/npm/@ionic/core/dist/ionic/ionic.esm.js")) attr_dev(script1, "src", script1_src_value);
    			add_location(script1, file$6, 137, 2, 3483);
    			script2.noModule = true;
    			if (script2.src !== (script2_src_value = "https://cdn.jsdelivr.net/npm/@ionic/core/dist/ionic/ionic.js")) attr_dev(script2, "src", script2_src_value);
    			add_location(script2, file$6, 138, 2, 3588);
    			attr_dev(link0, "rel", "stylesheet");
    			attr_dev(link0, "href", "https://cdn.jsdelivr.net/npm/@ionic/core/css/ionic.bundle.css");
    			add_location(link0, file$6, 139, 2, 3684);
    			attr_dev(link1, "href", "https://fonts.googleapis.com/css?family=Roboto:500,900i&display=swap");
    			attr_dev(link1, "rel", "stylesheet");
    			add_location(link1, file$6, 140, 1, 3780);
    			add_location(style, file$6, 142, 2, 3883);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(ion_app, midi_input);
    			append_dev(ion_app, t0);
    			append_dev(ion_app, ion_content);
    			append_dev(ion_content, div);
    			mount_component(flutestops, div, null);
    			append_dev(div, t1);
    			mount_component(percussionstops, div, null);
    			append_dev(div, t2);
    			mount_component(basssplit, div, null);
    			append_dev(div, t3);
    			mount_component(specialeffects, div, null);
    			append_dev(div, t4);
    			mount_component(syntheslalom, div, null);
    			...
    			dispose = [
    				listen_dev(midi_input, "noteon", /*playNote*/ ctx[11], false, false, false),
    				listen_dev(midi_input, "noteoff", /*stopNote*/ ctx[12], false, false, false),
    				listen_dev(
    					midi_input,
    					"firston",
    					function () {
    						if (is_function(/*slalom*/ ctx[3].startSlalom)) /*slalom*/ ctx[3].startSlalom.apply(this, arguments);
    					},
    					false,
    					false,
    					false
    				),
    				listen_dev(midi_input, "flush", /*flushAll*/ ctx[13], false, false, false),
    				listen_dev(button, "click", /*click_handler*/ ctx[30], false, false, false)
    			];
    		},
    		p: function update(new_ctx, [dirty]) {
    			ctx = new_ctx;
    			const flutestops_changes = {};

    			if (!updating_flutes && dirty & /*synths*/ 128) {
    				updating_flutes = true;
    				flutestops_changes.flutes = /*synths*/ ctx[7][2];
    				add_flush_callback(() => updating_flutes = false);
    			}

    			flutestops.$set(flutestops_changes);
    			const percussionstops_changes = {};

    			if (!updating_percussion && dirty & /*synths*/ 128) {
    				updating_percussion = true;
    				percussionstops_changes.percussion = /*synths*/ ctx[7]["percussion"];
    				add_flush_callback(() => updating_percussion = false);
    			}

    			if (!updating_percOutput && dirty & /*percOutput*/ 1024) {
    				updating_percOutput = true;
    				percussionstops_changes.percOutput = /*percOutput*/ ctx[10];
    				add_flush_callback(() => updating_percOutput = false);
    			}

    			percussionstops.$set(percussionstops_changes);
    			const basssplit_changes = {};

    			if (!updating_bassSplitState && dirty & /*bassSplit*/ 32) {
    				updating_bassSplitState = true;
    				basssplit_changes.bassSplitState = /*bassSplit*/ ctx[5];
    				add_flush_callback(() => updating_bassSplitState = false);
    			}

    			if (!updating_bass && dirty & /*synths*/ 128) {
    				updating_bass = true;
    				basssplit_changes.bass = /*synths*/ ctx[7]["bass"];
    				add_flush_callback(() => updating_bass = false);
    			}

    			if (!updating_strings && dirty & /*synths*/ 128) {
    				updating_strings = true;
    				basssplit_changes.strings = /*synths*/ ctx[7]["bassStrings"];
    				add_flush_callback(() => updating_strings = false);
    			}

    			basssplit.$set(basssplit_changes);
    			const specialeffects_changes = {};

    			if (!updating_detune && dirty & /*fxDetune*/ 64) {
    				updating_detune = true;
    				specialeffects_changes.detune = /*fxDetune*/ ctx[6];
    				add_flush_callback(() => updating_detune = false);
    			}

    			if (!updating_piano && dirty & /*synths*/ 128) {
    				updating_piano = true;
    				specialeffects_changes.piano = /*synths*/ ctx[7]["fxPiano"];
    				add_flush_callback(() => updating_piano = false);
    			}

    			if (!updating_harpsichord && dirty & /*synths*/ 128) {
    				updating_harpsichord = true;
    				specialeffects_changes.harpsichord = /*synths*/ ctx[7]["fxHarpsichord"];
    				add_flush_callback(() => updating_harpsichord = false);
    			}

    			if (!updating_vibrato && dirty & /*fxInput*/ 512) {
    				updating_vibrato = true;
    				specialeffects_changes.vibrato = /*fxInput*/ ctx[9];
    				add_flush_callback(() => updating_vibrato = false);
    			}

    			specialeffects.$set(specialeffects_changes);
    			const syntheslalom_changes = {};

    			if (!updating_slalomSignal && dirty & /*slalomSignal*/ 256) {
    				updating_slalomSignal = true;
    				syntheslalom_changes.slalomSignal = /*slalomSignal*/ ctx[8];
    				add_flush_callback(() => updating_slalomSignal = false);
    			}

    			syntheslalom.$set(syntheslalom_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(flutestops.$$.fragment, local);
    			transition_in(percussionstops.$$.fragment, local);
    			transition_in(basssplit.$$.fragment, local);
    			transition_in(specialeffects.$$.fragment, local);
    			transition_in(syntheslalom.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(flutestops.$$.fragment, local);
    			transition_out(percussionstops.$$.fragment, local);
    			transition_out(basssplit.$$.fragment, local);
    			transition_out(specialeffects.$$.fragment, local);
    			transition_out(syntheslalom.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(ion_app);
    			/*flutestops_binding*/ ctx[14](null);
    			destroy_component(flutestops);
    			/*percussionstops_binding*/ ctx[16](null);
    			destroy_component(percussionstops);
    			/*basssplit_binding*/ ctx[19](null);
    			destroy_component(basssplit);
    			/*specialeffects_binding*/ ctx[23](null);
    			destroy_component(specialeffects);
    			/*syntheslalom_binding*/ ctx[28](null);
    			destroy_component(syntheslalom);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		for (const synth in synths) {
    			if (synth !== "percussion") synths[synth].connect(fxInput);
    		}
    	...
    	function flutestops_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(0, flutes = $$value);
    		});
    	}
    	...
    	function percussionstops_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(1, perc = $$value);
    		});
    	}

    	function percussionstops_percussion_binding(value_1) {
    		synths["percussion"] = value_1;
    		$$invalidate(7, synths);
    	}

    	function percussionstops_percOutput_binding(value_2) {
    		percOutput = value_2;
    		$$invalidate(10, percOutput);
    	}

    	function basssplit_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(2, bass = $$value);
    		});
    	}

    	function basssplit_bassSplitState_binding(value_3) {
    		bassSplit = value_3;
    		$$invalidate(5, bassSplit);
    	}
    	...
    	function basssplit_strings_binding(value_5) {
    		synths["bassStrings"] = value_5;
    		$$invalidate(7, synths);
    	}

    	function specialeffects_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(4, fx = $$value);
    		});
    	}

    	function specialeffects_detune_binding(value_6) {
    		fxDetune = value_6;
    		$$invalidate(6, fxDetune);
    	}

    	function specialeffects_piano_binding(value_7) {
    		synths["fxPiano"] = value_7;
    		$$invalidate(7, synths);
    	}

    	function specialeffects_harpsichord_binding(value_8) {
    		synths["fxHarpsichord"] = value_8;
    		$$invalidate(7, synths);
    	}

    	function specialeffects_vibrato_binding(value_9) {
    		fxInput = value_9;
    		$$invalidate(9, fxInput);
    	}

    	function syntheslalom_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(3, slalom = $$value);
    		});
    	}

    	function syntheslalom_slalomSignal_binding(value_10) {
    		slalomSignal = value_10;
    		$$invalidate(8, slalomSignal);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("flutes" in $$props) $$invalidate(0, flutes = $$props.flutes);
    		if ("perc" in $$props) $$invalidate(1, perc = $$props.perc);
    		if ("bass" in $$props) $$invalidate(2, bass = $$props.bass);
    		if ("slalom" in $$props) $$invalidate(3, slalom = $$props.slalom);
    		if ("fx" in $$props) $$invalidate(4, fx = $$props.fx);
    		if ("bassSplit" in $$props) $$invalidate(5, bassSplit = $$props.bassSplit);
    		if ("fxDetune" in $$props) $$invalidate(6, fxDetune = $$props.fxDetune);
    		if ("synths" in $$props) $$invalidate(7, synths = $$props.synths);
    		if ("slalomSignal" in $$props) $$invalidate(8, slalomSignal = $$props.slalomSignal);
    		if ("fxInput" in $$props) $$invalidate(9, fxInput = $$props.fxInput);
    		if ("percOutput" in $$props) $$invalidate(10, percOutput = $$props.percOutput);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*slalomSignal, synths, fxDetune*/ 448) {
    			 {
    				if (typeof slalomSignal !== "undefined") {
    					//connect slalom to first 5 synths
    					for (const synth in synths) {
    						if (synth !== "fxPiano" && synth !== "fxHarpsichord") slalomSignal.connect(synths[synth].detune);
    					}
    	...
    	return [
    		...
    		flushAll,
    		flutestops_binding,
    		flutestops_flutes_binding,
    		percussionstops_binding,
    		percussionstops_percussion_binding,
    		percussionstops_percOutput_binding,
    		basssplit_binding,
    		basssplit_bassSplitState_binding,
    		basssplit_bass_binding,
    		basssplit_strings_binding,
    		specialeffects_binding,
    		specialeffects_detune_binding,
    		specialeffects_piano_binding,
    		specialeffects_harpsichord_binding,
    		specialeffects_vibrato_binding,
    		syntheslalom_binding,
    		syntheslalom_slalomSignal_binding,
    		click_handler
    	];
    }
