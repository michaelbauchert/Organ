...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 16, 0, 240);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "id", /*id*/ ctx[2]);
    			attr_dev(input, "class", "svelte-h8czp");
    			add_location(input, file, 20, 0, 397);
    		},
    ...
    // (98:4) {#each percussionStops as stop}
    function create_each_block(ctx) {
    	let updating_active;
    	let current;

    	function organstopbutton_active_binding(value) {
    		/*organstopbutton_active_binding*/ ctx[10].call(null, value, /*stop*/ ctx[14]);
    	}

    	let organstopbutton_props = {
    		stopType: "percussion",
    		name: /*stop*/ ctx[14].name
    	};

    	if (/*stop*/ ctx[14].active !== void 0) {
    		organstopbutton_props.active = /*stop*/ ctx[14].active;
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*percussionStops*/ 1) organstopbutton_changes.name = /*stop*/ ctx[14].name;

    			if (!updating_active && dirty & /*percussionStops*/ 1) {
    				updating_active = true;
    				organstopbutton_changes.active = /*stop*/ ctx[14].active;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(98:4) {#each percussionStops as stop}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ion_card_title, file$1, 93, 4, 2241);
    			add_location(ion_card_header, file$1, 92, 2, 2218);
    			set_custom_element_data(ion_card_content, "class", "svelte-j8q9zs");
    			add_location(ion_card_content, file$1, 96, 2, 2312);
    			set_custom_element_data(ion_label0, "position", "stacked");
    			add_location(ion_label0, file$1, 104, 6, 2562);
    			...
    			add_location(ion_range0, file$1, 105, 6, 2618);
    			set_custom_element_data(ion_item0, "lines", "none");
    			add_location(ion_item0, file$1, 103, 4, 2531);
    			set_custom_element_data(ion_label1, "position", "stacked");
    			add_location(ion_label1, file$1, 111, 6, 2815);
    			set_custom_element_data(ion_range1, "mode", "ios");
    			set_custom_element_data(ion_range1, "min", "50");
    			set_custom_element_data(ion_range1, "max", "300");
    			add_location(ion_range1, file$1, 112, 6, 2870);
    			add_location(ion_item1, file$1, 110, 4, 2797);
    			add_location(ion_label2, file$1, 121, 6, 3066);
    			set_custom_element_data(ion_toggle, "slot", "end");
    			set_custom_element_data(ion_toggle, "mode", "md");
    			add_location(ion_toggle, file$1, 122, 6, 3108);
    			set_custom_element_data(ion_item2, "lines", "none");
    			add_location(ion_item2, file$1, 120, 4, 3035);
    			set_custom_element_data(ion_label3, "position", "stacked");
    			add_location(ion_label3, file$1, 125, 6, 3254);
    			set_custom_element_data(ion_range2, "mode", "ios");
    			set_custom_element_data(ion_range2, "min", "200");
    			set_custom_element_data(ion_range2, "max", "1500");
    			set_custom_element_data(ion_range2, "step", "25");
    			set_custom_element_data(ion_range2, "disabled", ion_range2_disabled_value = !/*repeat*/ ctx[2]);
    			add_location(ion_range2, file$1, 126, 6, 3308);
    			set_custom_element_data(ion_item3, "lines", "none");
    			add_location(ion_item3, file$1, 124, 4, 3223);
    			set_custom_element_data(ion_card, "class", "svelte-j8q9zs");
    			add_location(ion_card, file$1, 91, 0, 2204);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(ion_range0, "ionChange", /*ionChange_handler*/ ctx[11], false, false, false),
    				listen_dev(ion_range1, "ionChange", /*setDecay*/ ctx[4], false, false, false),
    				listen_dev(ion_toggle, "ionChange", /*ionChange_handler_1*/ ctx[12], false, false, false),
    				listen_dev(ion_range2, "ionChange", /*ionChange_handler_2*/ ctx[13], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*repeat*/ 4 && ion_range2_disabled_value !== (ion_range2_disabled_value = !/*repeat*/ ctx[2])) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	//reapeat dsp
    	let gain = new Tone$1.Gain().toMaster();

    	let scale = new Tone$1.ScaleExp();
    	let lfo = new Tone$1.LFO(3, 1, 0).chain(scale, gain.gain);
    	lfo.type = "sawtooth80";
    	...
    	function setDecay(event) {
    		...
    		if (!repeat) percussion.set({ "envelope": { "decay": value / 1000 } });
    	...
    	const writable_props = ["percussion"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<PercussionStops> was created with unknown prop '${key}'`);
    	});
    	...
    	const ionChange_handler_2 = e => lfo.frequency.rampTo(e.target.value / 100);

    	$$self.$set = $$props => {
    		if ("percussion" in $$props) $$invalidate(5, percussion = $$props.percussion);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("volumeSignal" in $$props) $$invalidate(3, volumeSignal = $$props.volumeSignal);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*percussion, percussionStops*/ 33) {
    			 percussion.set({
    				"oscillator": {
    					"partials": [
    						0,
    		...
    		if ($$self.$$.dirty & /*percussion, repeat, lfo*/ 38) {
    			 {
    ...
    class PercussionStops extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { percussion: 5, playNote: 6, stopNote: 7 });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ion_card_title, file$2, 55, 4, 1600);
    			add_location(ion_card_header, file$2, 54, 2, 1577);
    			set_custom_element_data(ion_card_content, "class", "svelte-h2sqff");
    			add_location(ion_card_content, file$2, 57, 2, 1666);
    			set_custom_element_data(ion_label, "position", "stacked");
    			add_location(ion_label, file$2, 64, 4, 1876);
    			set_custom_element_data(ion_range, "min", "0");
    			set_custom_element_data(ion_range, "max", "100");
    			set_custom_element_data(ion_range, "pin", "");
    			set_custom_element_data(ion_range, "mode", "ios");
    			add_location(ion_range, file$2, 65, 4, 1930);
    			set_custom_element_data(ion_item, "lines", "none");
    			add_location(ion_item, file$2, 63, 2, 1847);
    			set_custom_element_data(ion_card, "class", "svelte-h2sqff");
    			add_location(ion_card, file$2, 53, 0, 1563);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			ion_select_option2.textContent = "Cathedral";
    			t21 = space();
    			ion_select_option3 = element("ion-select-option");
    			ion_select_option3.textContent = "Spring";
    			t23 = space();
    			ion_select_option4 = element("ion-select-option");
    			ion_select_option4.textContent = "Plate";
    			t25 = space();
    			...
    			add_location(ion_card_title, file$3, 13, 4, 256);
    			add_location(ion_card_header, file$3, 12, 2, 233);
    			set_custom_element_data(ion_label0, "position", "stacked");
    			add_location(ion_label0, file$3, 18, 6, 396);
    			set_custom_element_data(ion_range0, "mode", "ios");
    			add_location(ion_range0, file$3, 19, 6, 451);
    			set_custom_element_data(ion_item0, "lines", "none");
    			add_location(ion_item0, file$3, 17, 4, 365);
    			set_custom_element_data(ion_label1, "position", "stacked");
    			add_location(ion_label1, file$3, 22, 6, 526);
    			set_custom_element_data(ion_range1, "mode", "ios");
    			add_location(ion_range1, file$3, 23, 6, 587);
    			add_location(ion_item1, file$3, 21, 4, 508);
    			set_custom_element_data(ion_label2, "slot", "start");
    			add_location(ion_label2, file$3, 28, 6, 704);
    			set_custom_element_data(ion_toggle, "slot", "end");
    			set_custom_element_data(ion_toggle, "mode", "md");
    			add_location(ion_toggle, file$3, 29, 6, 754);
    			set_custom_element_data(ion_item2, "lines", "none");
    			add_location(ion_item2, file$3, 27, 4, 673);
    			set_custom_element_data(ion_label3, "position", "stacked");
    			add_location(ion_label3, file$3, 33, 6, 901);
    			...
    			set_custom_element_data(ion_range2, "mode", "ios");
    			set_custom_element_data(ion_range2, "disabled", ion_range2_disabled_value = !/*chorusState*/ ctx[0]);
    			add_location(ion_range2, file$3, 34, 6, 955);
    			add_location(ion_item3, file$3, 32, 4, 883);
    			add_location(ion_label4, file$3, 41, 6, 1136);
    			set_custom_element_data(ion_select_option0, "value", "off");
    			add_location(ion_select_option0, file$3, 44, 8, 1281);
    			set_custom_element_data(ion_select_option1, "value", "barn");
    			add_location(ion_select_option1, file$3, 45, 8, 1345);
    			set_custom_element_data(ion_select_option2, "value", "cathedral");
    			add_location(ion_select_option2, file$3, 46, 8, 1415);
    			set_custom_element_data(ion_select_option3, "value", "spring");
    			add_location(ion_select_option3, file$3, 47, 8, 1491);
    			set_custom_element_data(ion_select_option4, "value", "plate");
    			add_location(ion_select_option4, file$3, 48, 8, 1561);
    			set_custom_element_data(ion_select, "value", "barn");
    			set_custom_element_data(ion_select, "interface", "popover");
    			add_location(ion_select, file$3, 42, 6, 1173);
    			set_custom_element_data(ion_item4, "lines", "none");
    			add_location(ion_item4, file$3, 40, 4, 1105);
    			set_custom_element_data(ion_label5, "position", "stacked");
    			add_location(ion_label5, file$3, 52, 6, 1694);
    			set_custom_element_data(ion_range3, "mode", "ios");
    			set_custom_element_data(ion_range3, "disabled", /*reverbState*/ ctx[2]);
    			add_location(ion_range3, file$3, 53, 6, 1751);
    			set_custom_element_data(ion_item5, "lines", "none");
    			add_location(ion_item5, file$3, 51, 4, 1663);
    			set_custom_element_data(ion_card, "class", "svelte-1lmbwyc");
    			add_location(ion_card, file$3, 11, 0, 219);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(ion_toggle, "ionChange", /*ionChange_handler*/ ctx[3], false, false, false),
    				listen_dev(ion_select, "ionChange", /*ionChange_handler_1*/ ctx[4], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*chorusState*/ 1 && ion_range2_disabled_value !== (ion_range2_disabled_value = !/*chorusState*/ ctx[0])) {
    				set_custom_element_data(ion_range2, "disabled", ion_range2_disabled_value);
    			}

    			if (dirty & /*reverbState*/ 4) {
    				set_custom_element_data(ion_range3, "disabled", /*reverbState*/ ctx[2]);
    			}
    		},
    		i: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let chorusState;
    	let reverb;
    	const ionChange_handler = e => $$invalidate(0, chorusState = e.target.checked);
    	const ionChange_handler_1 = e => $$invalidate(1, reverb = e.target.value);
    	...
    	$$self.$inject_state = $$props => {
    		if ("chorusState" in $$props) $$invalidate(0, chorusState = $$props.chorusState);
    		if ("reverb" in $$props) $$invalidate(1, reverb = $$props.reverb);
    		if ("reverbState" in $$props) $$invalidate(2, reverbState = $$props.reverbState);
    	};

    	let reverbState;

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*reverb*/ 2) {
    			 $$invalidate(2, reverbState = reverb === "off" ? true : false);
    		}
    	};

    	return [chorusState, reverb, reverbState, ionChange_handler, ionChange_handler_1];
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_custom_element_data(ion_label1, "position", "stacked");
    			add_location(ion_label1, file$4, 31, 4, 762);
    			...
    			set_custom_element_data(ion_range1, "mode", "ios");
    			add_location(ion_range1, file$4, 32, 4, 815);
    			add_location(ion_item1, file$4, 30, 2, 746);
    			add_location(ion_label2, file$4, 38, 4, 985);
    			set_custom_element_data(ion_select_option0, "value", "up");
    			add_location(ion_select_option0, file$4, 41, 6, 1148);
    			set_custom_element_data(ion_select_option1, "value", "down");
    			add_location(ion_select_option1, file$4, 42, 6, 1208);
    			set_custom_element_data(ion_select, "value", "up");
    			set_custom_element_data(ion_select, "interface", "popover");
    			add_location(ion_select, file$4, 39, 4, 1023);
    			set_custom_element_data(ion_item2, "lines", "none");
    			add_location(ion_item2, file$4, 37, 2, 956);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ion_card_title, file$5, 40, 4, 834);
    			set_custom_element_data(ion_toggle0, "slot", "end");
    			set_custom_element_data(ion_toggle0, "mode", "md");
    			add_location(ion_toggle0, file$5, 41, 4, 884);
    			set_custom_element_data(ion_item0, "lines", "none");
    			add_location(ion_item0, file$5, 39, 2, 804);
    			set_custom_element_data(ion_label0, "position", "stacked");
    			add_location(ion_label0, file$5, 45, 4, 1034);
    			set_custom_element_data(ion_range0, "mode", "ios");
    			set_custom_element_data(ion_range0, "disabled", ion_range0_disabled_value = !/*bassSplitState*/ ctx[0]);
    			add_location(ion_range0, file$5, 46, 4, 1086);
    			set_custom_element_data(ion_item1, "lines", "none");
    			add_location(ion_item1, file$5, 44, 2, 1005);
    			set_custom_element_data(ion_label1, "position", "stacked");
    			add_location(ion_label1, file$5, 51, 4, 1190);
    			set_custom_element_data(ion_range1, "mode", "ios");
    			set_custom_element_data(ion_range1, "disabled", ion_range1_disabled_value = !/*bassSplitState*/ ctx[0]);
    			add_location(ion_range1, file$5, 52, 4, 1245);
    			add_location(ion_item2, file$5, 50, 2, 1174);
    			set_custom_element_data(ion_label2, "position", "stacked");
    			add_location(ion_label2, file$5, 57, 4, 1349);
    			set_custom_element_data(ion_range2, "mode", "ios");
    			set_custom_element_data(ion_range2, "disabled", ion_range2_disabled_value = !/*bassSplitState*/ ctx[0]);
    			set_custom_element_data(ion_range2, "min", "10");
    			set_custom_element_data(ion_range2, "max", "1000");
    			add_location(ion_range2, file$5, 58, 4, 1403);
    			add_location(ion_item3, file$5, 56, 2, 1333);
    			add_location(ion_label3, file$5, 72, 4, 1688);
    			...
    			add_location(ion_toggle1, file$5, 73, 4, 1727);
    			set_custom_element_data(ion_item4, "lines", "none");
    			add_location(ion_item4, file$5, 71, 2, 1659);
    			set_custom_element_data(ion_card, "class", "svelte-7enaj9");
    			add_location(ion_card, file$5, 37, 0, 788);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(ion_toggle0, "ionChange", /*ionChange_handler*/ ctx[6], false, false, false),
    				listen_dev(ion_range2, "ionChange", /*ionChange_handler_1*/ ctx[7], false, false, false),
    				listen_dev(ion_toggle1, "ionChange", /*monoToggle*/ ctx[2], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["bassSplitState", "bass"];
    	...
    	const ionChange_handler_1 = e => bass.set({
    		"envelope": { "decay": e.target.value / 1000 }
    	});

    	$$self.$set = $$props => {
    		if ("bassSplitState" in $$props) $$invalidate(0, bassSplitState = $$props.bassSplitState);
    		if ("bass" in $$props) $$invalidate(1, bass = $$props.bass);
    	};

    	$$self.$capture_state = () => {
    		return { bassSplitState, bass, mono };
    	};
    ...
    function create_fragment$6(ctx) {
    	...
    	function flutestops_flutes_binding(value) {
    		/*flutestops_flutes_binding*/ ctx[13].call(null, value);
    	}

    	let flutestops_props = {};

    	if (/*flutesSynth*/ ctx[6] !== void 0) {
    		flutestops_props.flutes = /*flutesSynth*/ ctx[6];
    	}

    	const flutestops = new FluteStops({ props: flutestops_props, $$inline: true });
    	/*flutestops_binding*/ ctx[12](flutestops);
    	...
    	function percussionstops_percussion_binding(value_1) {
    		/*percussionstops_percussion_binding*/ ctx[15].call(null, value_1);
    	}

    	let percussionstops_props = {};

    	if (/*percSynth*/ ctx[7] !== void 0) {
    		percussionstops_props.percussion = /*percSynth*/ ctx[7];
    	}
    	...
    	/*percussionstops_binding*/ ctx[14](percussionstops);
    	binding_callbacks.push(() => bind(percussionstops, "percussion", percussionstops_percussion_binding));

    	function basssplit_bassSplitState_binding(value_2) {
    		/*basssplit_bassSplitState_binding*/ ctx[17].call(null, value_2);
    	}

    	function basssplit_bass_binding(value_3) {
    		/*basssplit_bass_binding*/ ctx[18].call(null, value_3);
    	}

    	let basssplit_props = {};

    	if (/*bassSplit*/ ctx[4] !== void 0) {
    		basssplit_props.bassSplitState = /*bassSplit*/ ctx[4];
    	}

    	if (/*bassSynth*/ ctx[8] !== void 0) {
    		basssplit_props.bass = /*bassSynth*/ ctx[8];
    	}

    	const basssplit = new BassSplit({ props: basssplit_props, $$inline: true });
    	/*basssplit_binding*/ ctx[16](basssplit);
    	...
    	const specialeffects = new SpecialEffects({ $$inline: true });

    	function syntheslalom_slalomSignal_binding(value_4) {
    		/*syntheslalom_slalomSignal_binding*/ ctx[20].call(null, value_4);
    	}

    	let syntheslalom_props = {};

    	if (/*slalomSignal*/ ctx[5] !== void 0) {
    		syntheslalom_props.slalomSignal = /*slalomSignal*/ ctx[5];
    	}
    	...
    	/*syntheslalom_binding*/ ctx[19](syntheslalom);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(script0, file$6, 60, 2, 1284);
    			...
    			add_location(script1, file$6, 61, 2, 1338);
    			...
    			add_location(script2, file$6, 62, 2, 1443);
    			attr_dev(link0, "rel", "stylesheet");
    			attr_dev(link0, "href", "https://cdn.jsdelivr.net/npm/@ionic/core/css/ionic.bundle.css");
    			add_location(link0, file$6, 63, 2, 1539);
    			attr_dev(link1, "href", "https://fonts.googleapis.com/css?family=Roboto:500,900i&display=swap");
    			attr_dev(link1, "rel", "stylesheet");
    			add_location(link1, file$6, 64, 1, 1635);
    			add_location(style, file$6, 66, 2, 1738);
    			add_location(midi_input, file$6, 180, 2, 5205);
    			attr_dev(div, "class", "svelte-1mmzpr3");
    			add_location(div, file$6, 182, 4, 5405);
    			...
    			add_location(ion_content, file$6, 181, 2, 5330);
    			add_location(ion_app, file$6, 179, 0, 5193);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "name", "button");
    			add_location(button, file$6, 192, 0, 5769);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(midi_input, "noteon", /*playNote*/ ctx[9], false, false, false),
    				listen_dev(midi_input, "noteoff", /*stopNote*/ ctx[10], false, false, false),
    				listen_dev(
    					midi_input,
    					"firston",
    					function () {
    				...
    				listen_dev(midi_input, "flush", /*flushAll*/ ctx[11], false, false, false),
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!updating_flutes && dirty & /*flutesSynth*/ 64) {
    				updating_flutes = true;
    				flutestops_changes.flutes = /*flutesSynth*/ ctx[6];
    			...
    			if (!updating_percussion && dirty & /*percSynth*/ 128) {
    				updating_percussion = true;
    				percussionstops_changes.percussion = /*percSynth*/ ctx[7];
    			...
    			if (!updating_bassSplitState && dirty & /*bassSplit*/ 16) {
    				updating_bassSplitState = true;
    				basssplit_changes.bassSplitState = /*bassSplit*/ ctx[4];
    				add_flush_callback(() => updating_bassSplitState = false);
    			}

    			if (!updating_bass && dirty & /*bassSynth*/ 256) {
    				updating_bass = true;
    				basssplit_changes.bass = /*bassSynth*/ ctx[8];
    			...
    			if (!updating_slalomSignal && dirty & /*slalomSignal*/ 32) {
    				updating_slalomSignal = true;
    				syntheslalom_changes.slalomSignal = /*slalomSignal*/ ctx[5];
    		...
    		d: function destroy(detaching) {
    			...
    			/*flutestops_binding*/ ctx[12](null);
    			destroy_component(flutestops);
    			/*percussionstops_binding*/ ctx[14](null);
    			destroy_component(percussionstops);
    			/*basssplit_binding*/ ctx[16](null);
    			destroy_component(basssplit);
    			destroy_component(specialeffects);
    			/*syntheslalom_binding*/ ctx[19](null);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	function basssplit_bassSplitState_binding(value_2) {
    		bassSplit = value_2;
    		$$invalidate(4, bassSplit);
    	}

    	function basssplit_bass_binding(value_3) {
    		bassSynth = value_3;
    		$$invalidate(8, bassSynth);
    	}
    	...
    	function syntheslalom_slalomSignal_binding(value_4) {
    		slalomSignal = value_4;
    		$$invalidate(5, slalomSignal);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("bassSplit" in $$props) $$invalidate(4, bassSplit = $$props.bassSplit);
    		if ("slalomSignal" in $$props) $$invalidate(5, slalomSignal = $$props.slalomSignal);
    		if ("flutesSynth" in $$props) $$invalidate(6, flutesSynth = $$props.flutesSynth);
    		if ("percSynth" in $$props) $$invalidate(7, percSynth = $$props.percSynth);
    		if ("bassSynth" in $$props) $$invalidate(8, bassSynth = $$props.bassSynth);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*slalomSignal, flutesSynth, percSynth, bassSynth*/ 480) {
    			 {
    				if (typeof slalomSignal !== "undefined") slalomSignal.fan(flutesSynth.detune, percSynth.detune, bassSynth.detune);
    			}
    		}
    	};
